...
type AssignmentRepository interface {
	...
	GetAssignmentByIDAndCourseID(assignmentID int) (models.Assignment, error)
}
...
func (a *assignmentRepository) GetAssignmentByIDAndCourseID(assignmentID int) (models.Assignment, error) {
	panic("unimplemented")
}
